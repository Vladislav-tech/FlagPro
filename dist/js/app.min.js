  ...
  class FlagQuize {
    ...
    timer() {
      ...
      function setClock(id, endtime) {
        let currentTime = getTimeRemaining(id);

        minutes.textContent = currentTime.minutes;
        if (minutes.textContent.length < 2) {
          minutes.textContent = `0${currentTime.minutes}`;
        }

        seconds.textContent = currentTime.seconds;
        if (seconds.textContent.length < 2) {
          seconds.textContent = `0${currentTime.seconds}`;
        }
      }
